<!-- INICIO DE CUERPO DE PAGINA -->
    <div class="container-fluid">
        <div class="card">
            <h5 class="card-header"><i class="bi bi-truck"></i> Registro de Proveedor</h5>
            <form id="frm_proveedor" action="" method="">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <button type="reset" class="btn btn-info btn-sm" id="btn_limpiar_proveedor"><i class="bi bi-arrow-clockwise"></i> Limpiar</button>
                        <button type="button" class="btn btn-danger btn-sm" id="btn_cancelar_proveedor"><i class="bi bi-x-circle"></i> Cancelar</button>
                    </div>
                </div>
            </form>
        </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Botón Limpiar
        const btnLimpiar = document.getElementById('btn_limpiar_proveedor');
        if (btnLimpiar) {
        ...
        // Botón Cancelar
        const btnCancelar = document.getElementById('btn_cancelar_proveedor');
        if (btnCancelar) {
