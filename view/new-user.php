<!-- INICIO DE CUERPO DE PAGINA -->
    <div class="container-fluid">
        <div class="card">
            <h5 class="card-header"><i class="bi bi-person-plus"></i> Registro de Usuario</h5>
            <form id="frm_user" action="" method="">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <button type="reset" class="btn btn-info btn-sm" id="btn_limpiar"><i class="bi bi-arrow-clockwise"></i> Limpiar</button>
                        <button type="button" class="btn btn-danger btn-sm" id="btn_cancelar"><i class="bi bi-x-circle"></i> Cancelar</button>
                    </div>
                </div>
            </form>
        </div>
