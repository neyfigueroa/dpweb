<!-- INICIO DE CUERPO DE PAGINA -->
    <div class="container-fluid">
        <div class="card">
            <h5 class="card-header"><i class="bi bi-pencil-square"></i> Actualizar Proveedor</h5>
            <form id="frm_edit_proveedor" action="" method="">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <a href="<?php echo BASE_URL; ?>proveedor" class="btn btn-danger btn-sm"><i class="bi bi-x-circle"></i> Cancelar</a>
                    </div>
                </div>
            </form>
        </div>
