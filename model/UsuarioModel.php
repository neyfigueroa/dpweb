...
class UsuarioModel
{
    ...
    {
        // Devuelve id, razon_social, rol y password (necesario para verificar la contraseña)
        $stmt = $this->conexion->prepare("SELECT id, razon_social, rol, password, nro_identidad FROM persona WHERE nro_identidad = ? LIMIT 1");
